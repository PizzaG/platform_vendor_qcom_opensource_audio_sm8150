...
LOCAL_C_INCLUDES := \
    ...
    vendor/qcom/opensource/audio/sm8150/hal \
...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    vendor/qcom/opensource/audio/sm8150/hal \
    vendor/qcom/opensource/audio/sm8150/hal/$(AUDIO_PLATFORM) \
    $(call include-path-for, audio-effects)
...
PRIMARY_HAL_PATH := vendor/qcom/opensource/audio/sm8150/hal
AUDIO_PLATFORM := $(TARGET_BOARD_PLATFORM)
...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    vendor/qcom/opensource/audio/sm8150/hal \
    vendor/qcom/opensource/audio/sm8150/hal/audio_extn \
    vendor/qcom/opensource/audio/sm8150/hal/$(AUDIO_PLATFORM) \
